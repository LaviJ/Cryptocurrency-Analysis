...
## Machine Learning Model (Role Triangle by Lavina)
...
adding layers to LSTM : model = Sequential()
...
Then, ran the testing data. 

More coins done in the same manner

Then predicted the latest price and compared with the actual market price. 

Results_Daywise_LSTM are able to provide 77% accuracy. 
...
Short Term Investment Long-Term Investment High Risk Investment Low Risk Investment
...
Along with the above the following factors are important to be taken into consideration and they are :
...
Volatility:
Based on close price in 2018-2020, XRP was the most volatile, Tether was the most stable Time Series Forecasting and Seasonality Analysis : Days of week with highest trading : Tuesday to Thursday Months with highest trading : March to June Correlation: all cryptocurrencies have a positive correlation except Tether (USDT)
...
Time Series Forecasting and Seasonality Analysis : Days of week with highest trading : Tuesday to Thursday Months with highest trading : March to June
